document.addEventListener('DOMContentLoaded', () => {
    ...
    // Define o background com base na imagem de perfil
    const setBackground = () => {
    ...
    // Atualiza a imagem do perfil conforme o tema
    ...
    // Função para exibir feedback de cópia
    function showCopyFeedback() {
        copyFeedback.classList.add('show');
        setTimeout(() => {
            copyFeedback.classList.remove('show');
...
// Função para animar o texto "Pablu" no footer (apenas uma vez)
